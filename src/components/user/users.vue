    ...
    <el-card>
      ...
      <el-table
        ...
        <template slot-scope="scope">
            ...
            <el-button size="min" type="warning" icon="el-icon-setting" @click="setRolelist(scope.row)" circle></el-button>
            </el-tooltip>
        </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    async setUserRole () {
      if (!this.roleId) return this.$message.error('请选择要分配的角色！')
